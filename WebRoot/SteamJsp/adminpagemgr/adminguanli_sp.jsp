...
<div class="guanliwenben">
  ...
  %> --%>
	<c:forEach items="${commoditySelect}" var="item">
		<p class="commodityInfo">商品:${item.name}</p>
	</c:forEach>

	<c:forEach items="${commoditySelect}" var="item">
		<input class="ciid" type="text" value="${item.ciid}" hidden="true">
		<input class="name" type="text" value="${item.name}" hidden="true">
		<input class="faXing" type="text" value="${item.faXing}" hidden="true">
		<input class="data" type="text" value="${item.data}" hidden="true">
		<input class="Money" type="text" value="${item.money}" hidden="true">
		<input class="kaiFa" type="text" value="${item.kaiFa}" hidden="true">
		<%-- <input class="playJianJie" type="text" value="${item.playJianJie}" hidden="true"> --%>
		<input class="playJianJie" type="hidden" value="${item.playJianJie}" hidden="true">
		<input class="guanYu" type="hidden" value="${item.guanYu}" hidden="true">
	</c:forEach>
